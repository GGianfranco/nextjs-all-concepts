    ...
    >
      ...
      <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
        <div className="lg:w-1/2">
          <h2 className="max-w-md mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none xl:max-w-lg">
            List of projects with the corresponding technology used.
          </h2>
        </div>
        <div className="lg:w-1/2">
          <p className="text-base text-gray-700 md:text-lg">
            The following aims to practice authentication and database
            integration using Firebase tools. For faster front-end development,
            TailwindCSS is leveraged. And with fetching data from third party
            APIs, the TMDB API and Spotify API are used for the purpose of
            genrating sample sample data.
          </p>
        </div>
      </div>
      <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Food Cards</h6>
        ...
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Counter App</h6>
          <p className="mb-3 text-sm text-gray-900">
        ...
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Netflix Clone</h6>
          <p className="mb-3 text-sm text-gray-900">
        ...
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Spotify Clone</h6>
          <p className="mb-3 text-sm text-gray-900">
